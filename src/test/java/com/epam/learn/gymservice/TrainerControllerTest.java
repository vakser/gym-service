...
import com.epam.learn.gymservice.controller.TrainerController;
...
public class TrainerControllerTest {
    ...
    void testAddTraining_Success() {
        ...
        // Act
        ResponseEntity<String> response = trainerController.addTraining(username, addTrainingRequest, headers);
